    ...
    def extract_text_features(
        ...
        if captions is None and text_encoding is None:
            if self.backend_text_features is None:
                raise ValueError(
                    "`backend_text_features` is None, either `captions` or `text_encoding` should be given!")
            else:
            ...
            if use_backend_image_features:
                if self.backend_image_features is None:
                    if images is not None or pixel_values is not None:
                        print(
                            "`backend_image_features` is None, use the features of given images or pixel values instead.")
            ...
            if use_backend_text_features:
                if self.backend_text_features is None:
                    if captions is not None or text_encoding is not None:
                        print(
                            "`backend_text_features` is None, use the features of given captions or text_encodings instead.")
